    ...
    <div className="min-h-screen flex flex-col bg-slate-50 pb-20 md:pb-10">
      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 sm:px-6 py-6 w-full space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="px-3.5 py-2 bg-slate-50 border border-slate-200 text-slate-900 rounded-2xl text-xs font-bold flex items-center space-x-2 self-start sm:self-auto">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs">
                ...
                <button
                  type="button"
                  onClick={handleCopy}
                  className="text-slate-600 hover:text-slate-800 font-bold flex items-center space-x-1"
                >
              ...
              <textarea
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-2xl p-4 text-xs font-medium text-slate-900 focus:outline-hidden focus:ring-2 focus:ring-slate-500 font-mono leading-relaxed"
