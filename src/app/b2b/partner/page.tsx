        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-xl space-y-8 print:border-none print:shadow-none print:p-0 print:rounded-none">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            ...
            <div className="p-5 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
              ...
              <p className="text-slate-600 leading-relaxed">
                Aucun colis n&apos;est remis sans validation du <strong>Code Secret OTP</strong> du client. L&apos;argent liquide ou Mobile Money (Orange Money, Moov Money) est encaissé avec une traçabilité à 100%.
              </p>
            </div>
