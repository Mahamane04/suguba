...
import {
  PackagePlus, ShieldCheck, CheckCircle2, ArrowLeft, ChevronDown
} from 'lucide-react';
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none px-3.5 py-2.5 pr-10 bg-slate-50 border border-slate-300 rounded-xl text-base sm:text-sm font-medium text-slate-900 focus:bg-white focus:outline-emerald-600"
                >
