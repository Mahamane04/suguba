      ...
      <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl border border-slate-100 overflow-hidden max-h-[92vh] flex flex-col">
        ...
        <div className="p-4 bg-slate-900 text-white flex items-center justify-between print:hidden">
          ...
          <div className="flex items-center space-x-2">
            <button
              onClick={handlePrint}
              className="px-3 py-1.5 bg-suguba-profond hover:bg-suguba-profond-2 text-white rounded-xl text-xs font-bold flex items-center space-x-1.5 shadow-xs"
            >
        ...
        <div className="p-6 sm:p-8 space-y-6 overflow-y-auto font-mono text-slate-900 text-xs print:p-0 print:m-0">
          ...
          <div className="text-center space-y-1 border-b-2 border-dashed border-slate-300 pb-4">
            ...
            <p className="text-xs text-slate-500 font-sans">Plateforme de Social Commerce & Logistique</p>
            <p className="text-xs font-sans">Bamako, Mali • Tél : <strong>+223 89 46 00 00</strong></p>
            <p className="text-xs text-slate-500 font-sans">https://app.sugubaml.com</p>
          </div>
          ...
          <div className="space-y-2 border-b-2 border-dashed border-slate-300 pb-4">
            <div className="flex justify-between font-bold text-xs uppercase text-slate-500 border-b border-slate-200 pb-1">
            ...
            <div className="flex justify-between py-1 text-xs">
              <div>
                ...
                <span className="text-slate-500 block text-xs">Qté : {order.quantity} x {((order.totalProductAmount) / order.quantity).toLocaleString('fr-FR')} F</span>
              </div>
          ...
          <div className="border-2 border-slate-900 rounded-xl p-3 text-center space-y-1">
            ...
            <div className="text-2xl font-bold tracking-[0.3em] font-mono">
              {order.deliveryOtp}
            </div>
